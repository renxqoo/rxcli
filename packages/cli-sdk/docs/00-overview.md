...
| 18  | 插件钩子     | 6 个:beforeCommand/prepareRequest/observeRequest/handleUnauthorized/transformOutput/handleError;**enforce 三档**(pre/normal/post);observeError/handleError 链式 | `02-sdk-guide.md`   |
